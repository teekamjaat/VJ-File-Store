    ...
    for id in channel:
        ...
        try:
            ...
            btn.append([
                ...
                InlineKeyboardButton('Join {chat.title}', url="https://t.me/+7TJrDvsrUzZlNmQ1"),
                InlineKeyboardButton('Join {chat.title}', url="https://t.me/+rwlImG4-g75jMjE1")
            ])
...
def formate_file_name(file_name):
    ...
    for c in chars:
        file_name.replace(c, "")
    file_name = '@TJ_Bots ' + ' '.join(filter(lambda x: not x.startswith('http') and not x.startswith('@') and not x.startswith('www.'), file_name.split()))
    return file_name
